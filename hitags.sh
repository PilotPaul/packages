...
#ctags -I __THROW -I __attribute_pure__ -I __nonnull -I __attribute__ --file-scope=yes --langmap=c:+.h --languages=c,c++ --links=yes --c++-kinds=+x --fields=+aiKlSz --extra=+q --langmap=c++:+.inl -h +.inl --exclude=lex.yy.cc --exclude=copy_lex.yy.cc --excmd=number -R -f ~/.vim/systags /usr/local/src/gcc/gcc-6.4.0
